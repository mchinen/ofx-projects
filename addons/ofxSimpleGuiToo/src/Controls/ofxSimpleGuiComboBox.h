...
public:
   ...
   //choiceTitles is an array of const char* strings that can be NULL in which case numbers will be used to display the choices
   //the titles can be movified later with the below documented add/set/removeChoice methods
   ofxSimpleGuiComboBox(string name, int &choice_out, int numChoices,  ofxSimpleGuiPage *owner, const char** choiceTitles = NULL ) ;
